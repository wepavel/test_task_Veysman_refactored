...
**Запрос** `application/json`
- **Query-параметр**
  - `prefix` — Путь к папке в файловом хранилище, в которой необходимо получить список файлов. Опциональный параметр - если не указан, то будет возвращён список всех файлов в хранилище.
